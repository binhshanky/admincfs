                                        ...
                                        <div class="kt-portlet__head">
                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="form-group form-group-last">
                                                    <div class="alert alert-secondary" role="alert">
                                                        ...
                                                        <div class="alert-text">
                                                            Hãy xem xét kĩ nội dung trước khi đăng tải
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-group-last">
                                                    ...
                                                    <textarea class="form-control" id="confession" rows="20"><? echo $ndcfs; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="form-group form-group-last">
                                                    <div class="alert alert-secondary" role="alert">
                                                        <div class="alert-icon"><i class="flaticon-warning kt-font-brand"></i></div>
                                                        <div class="alert-text">
                                                            Đây là những công cụ giúp bạn chỉnh sửa nhanh<br><code>Hãy cẩn trọng khi sử dụng để tránh thay đổi ý nghĩa confession </code>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Công cụ</label><br>
													<button  class="btn btn-brand tools" id="fixmatcuoi">Khắc phục dư dấu mặt cười</button>
                                                </div>
